...
if __name__ == "__main__":
    ...
    agent.model.load_weights(r"C:\Users\Rio\Desktop\Review\models\dueling_dqn.h5")
    ...
    while not game.is_episode_finished():
        ...
        if t % 10000 == 0:
            ...
            agent.model.save_weights(r"C:\Users\Rio\Desktop\Review\models\dueling_dqn.h5", overwrite=True)
        ...
        if (is_terminated):
            ...
            if GAME % agent.stats_window_size == 0 and t > agent.observe: 
                ...
                with open(r"C:\Users\Rio\Desktop\Review\statistics\dueling_dqn_stats.txt", "w") as stats_file:
