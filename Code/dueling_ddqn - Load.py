...
from keras.layers import Conv2D, Dense, Flatten, Input, Lambda, add
...
def dueling_dqn(input_shape, action_size, learning_rate):
    ...
    x = Conv2D(32, 8, strides=(4, 4), activation='relu')(state_input)
    x = Conv2D(64, 4, strides=(2, 2), activation='relu')(x)
    x = Conv2D(64, 3, 3, activation='relu')(x)
    x = Flatten()(x)

    state_value = Dense(256, activation='relu')(x)
    state_value = Dense(1)(state_value)
    state_value = Lambda(lambda s: K.expand_dims(s[:, 0], -1), output_shape=(action_size,))(state_value)
...
if __name__ == "__main__":
    ...
    agent.model.load_weights(r"C:\Users\Rio\Desktop\Review\models\dueling_ddqn.h5")
    ...
    while not game.is_episode_finished():
        ...
        if t % 10000 == 0:
            ...
            agent.model.save_weights(r"C:\Users\Rio\Desktop\Review\models\dueling_ddqn.h5", overwrite=True)
        ...
        if (is_terminated):
            ...
            if GAME % agent.stats_window_size == 0 and t > agent.observe: 
                ...
                with open(r"C:\Users\Rio\Desktop\Review\statistics\dueling_ddqn_stats.txt", "w") as stats_file:
